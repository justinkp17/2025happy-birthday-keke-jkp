const fetchData = () => {
 ...
 const animationTimeline = () => {
   ...
   tl
     ...
     .call(() => {
       // Start playing audio during balloon animation
       if (audio) {
         audio.currentTime = 0;
         audio.loop = false;
     ...
     .call(() => {
       // Show YouTube embed after last animation
       if (youtubeEmbed) {
         youtubeEmbed.classList.remove('hide');
   ...
   if (replyBtn) {
     replyBtn.addEventListener("click", () => {
       // Stop audio before restarting animation
       if (audio) {
         audio.pause();
         audio.currentTime = 0;
       }
       
       // Hide YouTube embed with smooth transition
       if (youtubeEmbed) {
         youtubeEmbed.classList.remove('show');
         youtubeEmbed.classList.add('hide');
       }
       
       // Restart timeline after transition completes
       setTimeout(() => {
         tl.restart();
